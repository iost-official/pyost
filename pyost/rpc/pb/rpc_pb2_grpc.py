...
class ApiServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetProducerVoteInfo = channel.unary_unary(
        '/rpcpb.ApiService/GetProducerVoteInfo',
        request_serializer=rpc_dot_pb_dot_rpc__pb2.GetProducerVoteInfoRequest.SerializeToString,
        response_deserializer=rpc_dot_pb_dot_rpc__pb2.GetProducerVoteInfoResponse.FromString,
        )
...
class ApiServiceServicer(object):
  ...
  def GetProducerVoteInfo(self, request, context):
...
def add_ApiServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetProducerVoteInfo': grpc.unary_unary_rpc_method_handler(
          servicer.GetProducerVoteInfo,
          request_deserializer=rpc_dot_pb_dot_rpc__pb2.GetProducerVoteInfoRequest.FromString,
          response_serializer=rpc_dot_pb_dot_rpc__pb2.GetProducerVoteInfoResponse.SerializeToString,
      ),
