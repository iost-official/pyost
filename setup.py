...
setup(
  ...
  packages = ['pyost'],   # Chose the same as "name"
  version = 'v2.1-beta.1',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/dossiman/pyost/archive/v2.1-beta.1.tar.gz',    # I explain this later on
