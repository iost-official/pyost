...
if __name__ == '__main__':
    ...
    node_seckey = b'1rANSfcRzr4HkhbUFZ7L1Zp69JZZHiDDq5v7dNSbbEqeU4jxy3fszV4HGiaLQEyqVpS1dKT9g7zCVRxBVzuiUzB'
    ...
    seckey1 = b'3gLThtqcsJS4zgtXkfUksY9XM6pUXSM3mC6fZb9PkHURg171gsrpLXBtapme7Kwx24xi6qkE55CZaH7iBa5kWjNC'
    ...
    seckey2 = b'3vFoZPT1c3FSNVa9qrYMa2SQyxNQ8dfLSySNSzWokZQb4U1HToW1qUL3XzhpDE66MnjeUGwSDrYDJYgDFUary4Mb'
    ...
    sleep(5)
    try:
        tx_res = iost.get_tx_by_hash(tx_hash)
        print(tx_res)
